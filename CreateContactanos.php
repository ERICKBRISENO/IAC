...
$ButtonIniciar=Buttons::doButtonSubmit("200px","40px","ENVIAR",$Id);
...
$FORM=GenHtml::doForm($Id,"","","","CreateContactanosGuardar.php","_self","post","",$Cuestionario);
...
$BanerAzul = "<div id='' style=\"$Style\"><img id=\"\" src=\"http://iac-softwareparacondominios.com/IMG/IACCONTACTANOS.png\" alt=\"BANERAZUL\" ></div>";
...
$Window = HtmlWindow::doBasicWindow('','850px','500px',"Registrese y Cree Rapidamente Sus Condominios",$html);
